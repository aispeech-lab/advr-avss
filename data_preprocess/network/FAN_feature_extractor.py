...
class HourGlass(nn.Module):
    ...
    def _forward(self, level, inp):
        ...
        up2 = F.upsample(low3, size=rescale_size, mode='bilinear', align_corners=True)
        return up1 + up2
...
if __name__ == '__main__':
    ...
    model = FanFusion(args)
    x = torch.from_numpy(np.random.randn(1, 3, 256, 256).astype('float32'))
